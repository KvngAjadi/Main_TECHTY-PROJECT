...
const PersonalizeComp = () => {
  return (
    <div className="flex gap-10 mt-5 pb-4">
      <div>
        <img
          src="/Rectangle.png"
          alt="Phone display"
          className="w-140 hidden md:block"
        />
      </div>
      <div className="flex flex-col gap-7 mt-40">
        <h1 className="text-white font-space font-bold text-5xl">
          Personalize your business <br />
          <span className="font-space text-[#28D08A]">strategy </span>to reach
          out.
        </h1>
        <p className="text-[20px] text-md font-normal font-space text-white">
          Our advisors approach each client individually, so each time we <br />
        ...
        <div className="flex gap-10">
          <div>
            ...
            <p className="font-space mt-3 text-[20px] text-white">
