...
const PriorityComp = () => {
  return (
    <div className="relative flex max-sm:flex-col gap-25 max-sm:gap-2">
      <div className="flex flex-col pl-10 gap-5 mt-15 max-sm:mt-1">
      ...
      />
      <div className="absolute bottom-16 left-140 bg-white shadow-lg p-4 max-w-xs max-sm:hidden">
