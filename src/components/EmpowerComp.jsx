...
const EmpowerComp = () => {
  return (
      ...
      <div className="flex flex-col font-space mt-10 pl-3 ">
        ...
        <p>Creating or improving products to meet <br />our users needs</p>
        </div>
      ...
      <div className="flex flex-col font-space mt-10 pl-3 ">
        ...
        <div className="flex mt-20 gap-10 px-15">
            ...
            <div className="flex flex-col font-space gap-5 mt-10">
                ...
                <p className="text-[15px] font-normal">With our Techty company, you can create landing pages that convert more <br /> visitors than any other website. You can easily create a page using a variety <br /> of unique blocks.</p>
                <p className="text-[20px] font-normal">We collect ideas from different design inspirations,</p>
                <p className="text-[20px] font-normal">Analysis data for any kind of corrections.</p>
                <p className="text-[20px] font-normal">Finalize the product for the production to be done.</p>
                        <Button name='Request a Free Demo' style={"bg-black hover:bg-[#28D08A] text-white text-[15px] items-center flex justify-center rounded-md w-60 font-space h-13 font-semibold"}/>
            </div>
        </div>
    </div>
  );
